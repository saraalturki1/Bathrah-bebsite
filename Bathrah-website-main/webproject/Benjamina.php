...
<div class="container">
  <img src="https://johnlewis.scene7.com/is/image/JohnLewis/238398970alt3?$rsp-pdp-port-1440$" height="600" alt="hawraa">
  <div class="box"><h1>فيكس بنجامينا</h1> <br> <h2>
الري<br> </h2>
.لا يتم ريها إلا بعد جفاف التربة جزئيا، ويفضل رش أوراقها برذاذ الماء باستمرار كونها محبة للرطوبة<br><h2>
 الاضاءة<br></h2>
.تحتاج ضوء ساطع مرشح مثل ضوء النافذة<br><h2>
 درجة الحرارة<br></h2>
تحتاج إلى جو معتدل ويناسبها درجة حرارة الغرفة الطبيعية وتتحمل الجو الدافئ حتى 30 درجة مئوية
<h2>
الوصف<br></h2>
ذات أوراق خضراء جميلة، من النباتات المنقية للجو، يمكن وضعها في المداخل حيث تمنح المكان .مظهر جميل ورائع أو في صالات الجلوس
</div>
