...
<div class="container">
  <img src="https://www.saga.co.uk/contentlibrary/saga/publishing/verticals/home-and-garden/gardening/advice-and-tips/flowers/growing-winter-heather.jpg" height="450" alt="كالونا">
  <div class="box">
  <h1>كالونا</h1> 
  <h2>الري<br>
  </h2>يتم ريها كل ماجف سطح التربة، مع الحرص على ابقائها رطبة وعدم تركها لتجف تمام<br>
  <h2>الاضاءة<br>
  </h2>تحتاج إلى ضوء ساطع بإنارة شمس مباشرة أو جزئية.<br>
  <h2>درجة الحرارة<br></h2>
تحتاج إلى جو معتدل يناسبها درجة حرارة الغرفة الطبيعية اذا قررت وضعها داخل المنزل، وتتحمل الجو الدافئ حتى 82
درجة مئوية<h2>
الوصف<br></h2>
الكالونا يتمتع بزهور ألوانها لا متناهيه وزاهية وجذابة جدا،لذا يشيع استخدامه وبكثرة في الحدائق الزينية، وفي باقات الزهور المستخدمة في مختلف المناسبات
</div>
</div>
