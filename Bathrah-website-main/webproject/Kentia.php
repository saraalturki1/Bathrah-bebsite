...
<div class="container">
  <img src="https://cdn.shopify.com/s/files/1/0758/3437/products/Kentia_palm_800x.jpg?v=1588162914" height="600" alt="hawraa">
  <div class="box"><h1>كينيتا</h1> <br> <h2>
الري<br> </h2>
.لا يتم ريها إلا بعد جفاف التربة جزئياً، ويفضل رش أوراقها برذاذ الماء من فترة لأخرى، كما أنها تتحمل الجفاف بشكل جيد<br><h2>
 الاضاءة<br></h2>
.تحتاج ضوء ساطع مرشح مثل ضوء النافذة<br><h2>
 درجة الحرارة<br></h2>
تحتاج إلى جو معتدل ويناسبها درجة حرارة الغرفة الطبيعية وتتحمل الجو الدافئ حتى 30 درجة مئوي
<h2>
الوصف<br></h2>
من النباتات الجميلة والتي تتحمل الجفاف بشكل جيد، تتميز بأوراق ريشية رقيقة ولون أخضر مشرق، يمكن وضعها في المنزل أو بيئات العمل المختلفة
</div>
