...
<div class="container">
  <img src="https://i.pinimg.com/originals/94/59/cc/9459ccb2c54184b9dc76a5ef2e1bc669.jpg" height="600" alt="hawraa">
  <div class="box"><h1>صبار حوراء القصر</h1> <br> <h2>
الري<br> </h2>
لا يتم ريها إلا بعد جفاف التربة<br><h2>
 الاضاءة<br></h2>
تحتاج ضوء معتدل إلى ساطع مرشح مثل ضوء النافذة أو الانارة الصناعية للغرفة، ويمكن .وضعها في الاماكن متوسطة الاضاءة<br><h2>
 درجة الحرارة<br></h2>
تحتاج إلى جو معتدل يناسبها درجة حرارة الغرفة الطبيعية، وتتحمل الجو الدافئ حتى  35 درجة مئوية
<h2>
الوصف<br></h2>
تعتبر من النباتات العصارية والدائمة الخضرة ولاتحتاج للكثير من العناية
</div>
