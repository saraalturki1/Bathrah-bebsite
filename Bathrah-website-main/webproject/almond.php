...
height="600">
  <div class="box">
     <h1>شجرة لوز حساوي</h1> 
  <h2>الري<br>
  </h2>يتم الري بانتظام يوميًا<br>
  <h2>الاضاءة<br>
  </h2>تحتاج لأشعة الشمس المباشرة<br>
  <h2>درجة الحرارة<br></h2>
لا يتحمل شدة البرد<h2>
الوصف<br></h2>
شجرة لوز حساوي او اللوز البجلي شجرة واسعة الانتشار في المناطق المدارية. وفي الرياض ليست ناجحة في كل الأحوال
لإنخفاض الرطوبة، ولكن في المواقع المحمية حيث تروى النباتات الأخرى فإن نموها وأوراقها تتكون في صورة أحسن
</div>
</div>
