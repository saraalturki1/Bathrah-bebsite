...
<div class="container">
  <img src="https://images-na.ssl-images-amazon.com/images/I/61BCdviQUfL._AC_SL1000_.jpg" height="600" alt="hawraa">
  <div class="box"><h1>باشيرا</h1> <br> <h2>
الري<br> </h2>
...
.تحتاج ضوء ساطع مرشح مثل ضوء النافذة أو الانارة الصناعية للغرفة<br><h2>
 درجة الحرارة<br></h2>
تحتاج جو معتدل إلى بارد يناسبها درجة حرارة الغرفة الطبيعية حتى 25 درجة مئوية
<h2>
الوصف<br></h2>
￼￼ذات أوراق خضراء مشرقة، تعتبر من النباتات الممكن تربيتها كنبتة بونساي، ويمكن وضعها في المنازل أو بيئات العمل المختلفة
</div>
