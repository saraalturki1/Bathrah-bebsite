...
<div class="container">
  <img src="https://images.homedepot-static.com/productImages/f5b67eda-0f4d-4eba-9c4a-a71352954830/svn/national-plant-network-house-plants-hd7230-64_1000.jpg" height="600" alt="hawraa">
  <div class="box"><h1>زهرة الزنبق</h1> <br> <h2>
الري<br> </h2>
.لا يتم ريها إلا بعد جفاف التربة جزئياً، ويفضل رش أوراقها برذاذ الماء باستمرار كونها محبة للرطوبة<br><h2>
 الاضاءة<br></h2>
.تحتاج ضوء ساطع مرشح مثل ضوء النافذة<br><h2>
 درجة الحرارة<br></h2>
تحتاج جو معتدل إلى بارد يناسبها درجة حرارة الغرفة الطبيعية حتى 22 درجة مئوية
<h2>
الوصف<br></h2>
يتميز الزنبق بوجود أنواع كثيرة، ويضفي رائحة جميلة حيث يوضع عند تفتح أزهاره
</div>
