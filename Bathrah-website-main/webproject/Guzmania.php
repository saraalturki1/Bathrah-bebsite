...
<div class="container">
  <img src="https://www.jihadbinaa.org.lb/uploaded/2015/08/30.jpg" height="600" alt="hawraa">
  <div class="box"><h1>زهرة قوزمينيا</h1> <br> <h2>
الري<br> </h2>
.لا يتم ريها إلا بعد جفاف التربة جزئياً، ويفضل رش أوراقها برذاذ الماء باستمرار كونها محبة للرطوبة<br><h2>
 الاضاءة<br></h2>
.تحتاج ضوء ساطع مرشح مثل ضوء النافذة أو الانارة الصناعية للغرفة<br><h2>
 درجة الحرارة<br></h2>
تحتاج إلى جو معتدل ويناسبها درجة حرارة الغرفة الطبيعية وتتحمل الجو الدافئ حتى 30 درجة مئوي
<h2>
الوصف<br></h2>
تعتبر من النباتات الجميلة التي تتعدد ألوان أزهاره، حيث تضفي مظهر لطيف ومبهج، يمكن وضعها في غرف النوم أو المكاتب أو دورات المياة.
</div>
